...
\newcommand{\secsubtitle}[1]{
	{\vspace{-0.5cm}\small \color{gray} #1 \par}
}

\newcommand{\colvec}[1]{\begin{pmatrix}#1\end{pmatrix}}

\usepackage{silence}
\WarningFilter[wrapfiglisting]{wrapfig}{wrapfigure used inside a conflicting environment}
\WarningFilter[wrapfigforcefloat]{wrapfig}{Stationary wrapfigure forced to float}

\ActivateWarningFilters[wrapfigforcefloat]
